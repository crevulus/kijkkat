...
export function Miscellaneous() {
  return (
    <Container sx={miscellaneousStyles.container}>
      ...
      <p>
        At Kijkkat, accessible from kijkkat-meow.web.app, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Kijkkat
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Kijkkat. This policy is not applicable to any
      ...
      <p>
        Kijkkat follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Kijkkat uses 'cookies'. These cookies are used
      ...
      <p>
        ...
        advertising partners of Kijkkat.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Kijkkat, which are sent directly
      ...
      <p>
        Note that Kijkkat has no access to or control over these cookies that
      ...
      <p>
        Kijkkat's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Kijkkat does not knowingly collect any Personal Identifiable Information
